...
public class ConnectionPool {
	...
	static {
	    try {
            ...
            ClientLogger.logError("Error loading driver: " + e.getMessage());
        } catch (IOException e) {
            ClientLogger.logError("Error loading configuration file: " + e.getMessage());
        }
	}
	...
	protected ConnectionPool(String aJdbcURL, String aUsername, String aPassword, int aPreconnectCount,int aMaxIdleConnections,
		...
		try {
            ...
            ClientLogger.logError("Error during pre-connection initialization: " + e.getMessage());
		}
	...
	public synchronized Connection checkOut() throws SQLException {
        ...
        try {
            ...
            ClientLogger.logError("Error during connection checkout: " + e.getMessage());
            throw e;
        } catch (InterruptedException ex) {
            ClientLogger.logWarning("Thread interrupted during connection checkout: " + ex.getMessage());
        }
        return conn;
    }
	...
	public synchronized void checkIn(Connection aConn) {
        ...
        try {
            if (usedConnections.removeElement(aConn)) {
                ...
                while (freeConnections.size() > maxIdleConnections) {
                    ...
                    try {
                        ...
                        ClientLogger.logError("Error closing connection during check-in: " + ex.getMessage());
                    }
            ...
            ClientLogger.logError("Unexpected error during connection check-in: " + e.getMessage());
        }
    }
}